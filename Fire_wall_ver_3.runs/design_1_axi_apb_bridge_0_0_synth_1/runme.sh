...
HD_PWD='/home/fw3/thanhntd/Fire_wall_proj/Fire_wall_ver_3/Fire_wall_ver_3.runs/design_1_axi_apb_bridge_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_apb_bridge_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_apb_bridge_0_0.tcl
