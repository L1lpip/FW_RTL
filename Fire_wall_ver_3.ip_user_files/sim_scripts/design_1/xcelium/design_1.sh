...
#
# Script generated by Vivado on Sun Apr 12 22:40:39 +07 2026
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../Fire_wall_ver_3.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../Fire_wall_ver_3.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../Fire_wall_ver_3.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../bd/design_1/ip/design_1_axi_vip_0_0/sim/design_1_axi_vip_0_0_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_15 $xmvlog_opts -sv +incdir+"../../../../Fire_wall_ver_3.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../Fire_wall_ver_3.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/Vivado/2023.2/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ducthanh/thanhntd/Fire_wall_ver_3/Fire_wall_ver_3.cache/compile_simlib/xcelium"
  fi
