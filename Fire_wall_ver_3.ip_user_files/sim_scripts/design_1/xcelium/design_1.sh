...
#
# Script generated by Vivado on Tue Apr 14 08:54:36 +07 2026
...
design_libs_elab="-libname xilinx_vip -libname axi_infrastructure_v1_1_0 -libname xil_defaultlib -libname axi_vip_v1_1_15 -libname lib_pkg_v1_0_3 -libname axi_apb_bridge_v3_0_19 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip axi_infrastructure_v1_1_0 xil_defaultlib axi_vip_v1_1_15 lib_pkg_v1_0_3 axi_apb_bridge_v3_0_19)
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../Fire_wall_ver_3.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../Fire_wall_ver_3.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../Fire_wall_ver_3.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../bd/design_1/ip/design_1_axi_vip_0_0/sim/design_1_axi_vip_0_0_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_15 $xmvlog_opts -sv +incdir+"../../../../Fire_wall_ver_3.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvhdl -work axi_apb_bridge_v3_0_19 -V93 $xmvhdl_opts \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../Fire_wall_ver_3.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/fw3/thanhntd/FW_RTL/FW_RTL/Fire_wall_ver_3.cache/compile_simlib/xcelium"
  fi
