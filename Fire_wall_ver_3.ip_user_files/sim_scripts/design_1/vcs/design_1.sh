...
design_libs=(xilinx_vip axi_infrastructure_v1_1_0 xil_defaultlib axi_vip_v1_1_15 lib_pkg_v1_0_3 axi_apb_bridge_v3_0_19)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../Fire_wall_ver_3.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../Fire_wall_ver_3.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../../Fire_wall_ver_3.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../bd/design_1/ip/design_1_axi_vip_0_0/sim/design_1_axi_vip_0_0_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_15 $vlogan_opts -sverilog +incdir+"../../../../Fire_wall_ver_3.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../Fire_wall_ver_3.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/opt/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/fw3/thanhntd/FW_RTL/FW_RTL/Fire_wall_ver_3.cache/compile_simlib/vcs"
  fi
